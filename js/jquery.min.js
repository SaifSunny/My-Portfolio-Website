...
(function(factory) {
    ...
    function migrateWarnFuncInternal(obj, prop, newFunc, code, msg) {
        var finalFunc, origFunc = obj[prop];
        obj[prop] = function() {
            if (msg) {
                migrateWarn(code, msg)
            }
            finalFunc = jQuery.migrateIsPatchEnabled(code) ? newFunc : (origFunc || jQuery.noop);
    ...
    migratePatchAndWarnFunc(jQuery, "unique", jQuery.uniqueSort, "unique", "jQuery.unique is deprecated; use jQuery.uniqueSort");
    ...
    migrateWarnProp(jQuery.expr, ":", jQuery.expr.pseudos, "expr-pre-pseudos", "jQuery.expr[':'] is deprecated; use jQuery.expr.pseudos");
    ...
    if (jQuery.ajax) {
        ...
        if (!jQueryVersionSince("4.0.0")) {
            jQuery.ajaxPrefilter("+json", function(s) {
                if (s.jsonp !== !1 && (rjsonp.test(s.url) || typeof s.data === "string" && (s.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && rjsonp.test(s.data))) {
    ...
    migratePatchFunc(jQuery.fn, "toggleClass", function(state) {
        ...
        return this.each(function() {
            ...
            if (this.setAttribute) {
                this.setAttribute("class", className || state === !1 ? "" : jQuery.data(this, "__className__") || "")
            }
        })
    }, "toggleClass-bool");
    ...
    var origFnCss, internalSwapCall = !1,
        ralphaStart = /^[a-z]/,
    ...
    migratePatchAndWarnFunc(jQuery.fn, "andSelf", jQuery.fn.addBack, "andSelf", "jQuery.fn.andSelf() is deprecated and removed, use jQuery.fn.addBack()");
    if (jQuery.Deferred) {
