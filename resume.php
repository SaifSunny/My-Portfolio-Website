                                                        ...
                                                        <div id="col_inner" class="fw-col-inner"
                                                            ...
                                                            <div id="timeline" class="timeline clearfix">
                                                                ...
                                                                <div class="timeline-item clearfix">
                                                                    ...
                                                                    <h4 class="item-title">IT Executive</h4>
                                                                    <span class="item-company">i1Class.com</span>
                                                                    <div class="text">
                                                                        Accomplishments:
                                                                        <ul style="margin-top:0; padding-top:5px;">
                                                                            <li>Conducted training sessions for
                                                                                employees on the e-edu platform.</li>
                                                                            <li>Successfully optimized website SEO,
                                                                                resulting in a 20% increase in organic
                                                                                traffic.</li>
                                                                            <li>Developed comprehensive user manuals for
                                                                                smooth onboarding</li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div id="col_inner" class="fw-col-inner"
                                                            ...
                                                            <div id="timeline" class="timeline clearfix">
                                                                <div class="timeline-item clearfix">
                                                                    ...
                                                                    <br>
                                                                    <h4 class="item-title">Moodle Training Workshop
                                                                        Volenteer</h4>
                                                                    <span class="item-company">Center for Excellence in
                                                                        Teaching and Learning, ULAB</span>
                                                                    <div class="text">
                                                                ...
                                                                <div class="timeline-item clearfix">
                                                                    ...
                                                                    <br>
                                                                    <h4 class="item-title">Quality Teaching and
                                                                        Learning Workshop Volenteer</h4>
                                                                    <span class="item-company">Center for Excellence in
                                                                        Teaching and Learning, ULAB</span>
                                                                    <div class="text">
                                                                        <ul style="margin-top:0; padding-top:0;">
                                                    ...
                                                    <div class=" col-xs-12 col-sm-12 ">
                                                        <div id="col_inner" class="fw-col-inner"
                                                            ...
                                                            <div id="testimonials" class="testimonials owl-carousel"
                                                                data-mobile-items="1" data-tablet-items="2"
                                                                data-items="2">
