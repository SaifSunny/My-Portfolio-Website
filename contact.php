                                                            ...
                                                            <div class="info-list-w-icon">
                                                                ...
                                                                <div class="info-block-w-icon">
                                                                    ...
                                                                    <div class="ci-text">
                                                                        ...
                                                                        <p>Feel free to reach out to me via phone for
                                                                            any inquiries or collaborations. I'm
                                                                            available to discuss your project
                                                                            requirements or answer any questions you may
                                                                            have.</p>
                                                                    </div>
                                                                </div>
                                                                <div class="info-block-w-icon">
                                                                    ...
                                                                    <div class="ci-text">
                                                                        ...
                                                                        <p>I am open to local and remote opportunities.
                                                                            If you're in the area and interested in
                                                                            working, let's connect and discuss how we
                                                                            can collaborate.</p>
                                                                    </div>
                                                                </div>
                                                                <div class="info-block-w-icon">
                                                                    ...
                                                                    <div class="ci-text">
                                                                        <h4><a href="" class="__cf_email__"
                                                                                data-cfemail="">saifsunny56@gmail.com</a>
                                                                        </h4>
                                                                        <p>Whether it's a project proposal, partnership
                                                                            opportunity, or any other matter, I'll
                                                                            respond promptly to your message.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
