...
<body class="home custom-background wp-embed-responsive masthead-fixed full-width grid">
                                            ...
                                            <div class="fw-container">
                                                <div class="row">
                                                    ...
                                                    <div class=" col-xs-12 col-sm-12 ">
                                                        <div id="col_inner_46d9c8ad628b9795e60e3b893e0f3fd4" class="fw-col-inner" data-paddings="0px 0px 0px 0px">
                                                            <div class="lmpixels-map">
                                                                <iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d228.2151724982138!2d90.36192596107144!3d23.767242825969003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1687612160995!5m2!1sen!2sbd" title="3/11 A Block-F Kaderia Madrasa Road, Mohammadpur Dhaka-1207"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class=" col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                        <div id="col_inner_7311a7394317832c0b256771fd211c13" class="fw-col-inner" data-paddings="0px 0px 0px 0px">
                                                            ...
                                                            <div id="info-list-6496c726b95bd" class="info-list-w-icon">
                                                                ...
                                                                <div class="info-block-w-icon">
                                                                    ...
                                                                    <div class="ci-text">
                                                                        <h4>+880-1624034918</h4>
                                                                        <p>Feel free to reach out to me via phone for any inquiries or collaborations. I'm available to discuss your project requirements or answer any questions you may have.</p>
                                                                    </div>
                                                                </div>
                                                                <div class="info-block-w-icon">
                                                                    <div class="ci-icon">
                                                                    ...
                                                                    <div class="ci-text">
                                                                        ...
                                                                        <p>I am open to local and remote opportunities. If you're in the area and interested in working, let's connect and discuss how we can collaborate.</p>
                                                                    </div>
                                                                </div>
                                                                <div class="info-block-w-icon">
                                                                    <div class="ci-icon">
                                                                    ...
                                                                    <div class="ci-text">
                                                                        <h4><a href="" class="__cf_email__" data-cfemail="">saifsunny56@gmail.com</a></h4>
                                                                        <p>Whether it's a project proposal, partnership opportunity, or any other matter, I'll respond promptly to your message.</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class=" col-xs-12 col-sm-12">
                                                        <div id="col_inner_b9986d93abfbd322e79534dd003c0cb6" class="fw-col-inner" data-paddings="0px 0px 0px 0px">
                                                            ...
                                                            <div class="block-title" style="margin-top:2%">
                                                                <h2>How Can I Help You?</h2>
                                                            </div>

                                                            <form id="contact_form_6496c726b99d0" class="contact-form" action="#" method="post">
    ...
    <script type='text/javascript'
        src='js/bootstrap.min.js' id='js-2-js'>
    </script>
